...
var TenantWhere = struct {
	...
	ParentTenantID: whereHelpernull_String{field: "\"tenants\".\"parent_tenant_id\""},
...
var (
	...
	tenantColumnsWithoutDefault = []string{"name", "created_at", "updated_at"}
	tenantColumnsWithDefault    = []string{"id", "parent_tenant_id", "deleted_at"}
